...
insert into info (access, description, info_name, long_name, short_name, info_difr_id, info_test_id, user_id) values ("PRIVATE", "some description", "package2", "This is some loooong name", "This is some short name", null, null, 2)
insert into info (access, description, info_name, long_name, short_name, info_difr_id, info_test_id, user_id) values ("PRIVATE", "some description", "package3", "This is some loooong name", "This is some short name", null, null, 2)
insert into info (access, description, info_name, long_name, short_name, info_difr_id, info_test_id, user_id) values ("PRIVATE", "some description", "package4", "This is some loooong name", "This is some short name", null, null, 2)
